...
export const LoginPage: React.FC<LoginPageProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (activeTab === 'admin') {
      ...
      if (cleanUser === 'masukan ID' && cleanPass === 'Masukkan Password') {
        onLogin({
          role: 'admin',
          username: 'podtie13',
      ...
      setErrorMessage('ID Admin tidak terdaftar atau kata sandi salah. (ID Admin Utama: podtie13)');
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-slate-50 to-blue-50/40 flex flex-col justify-center items-center py-10 px-4 sm:px-6">
      <div className="w-full max-w-md">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={activeTab === 'guru' ? 'contoh: budi atau 19780512...' : 'podtie13'}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={activeTab === 'admin' ? 'Zionathan123' : 'Masukkan kata sandi...'}
        ...
        {/* Panel Bantuan Uji Coba Cepat (1-Klik) */}
